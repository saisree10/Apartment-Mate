...
public class UserProfileData extends Activity {
		...
		final Calendar c = Calendar.getInstance();
	        ...
	        try {
	    	  	...
	    	  	cc.moveToFirst();
	    	        if(cc.getCount()>0){
	    	        	...
	    	        	fullname.setText(cc.getString(cc.getColumnIndex("FullName")));
	    	    		ssn.setText(cc.getString(cc.getColumnIndex("SSN")));
	    	    		occupation.setText(cc.getString(cc.getColumnIndex("Occupation")));
	    	    		contact.setText(cc.getString(cc.getColumnIndex("Contact")));
	    	    		address.setText(cc.getString(cc.getColumnIndex("Address")));
	    	    		people.setText(cc.getString(cc.getColumnIndex("People")));
	    	    		pets.setText(cc.getString(cc.getColumnIndex("Pets")));
	    	    		vehicle.setText(cc.getString(cc.getColumnIndex("Vehicle")));
	    	    		flat.setText(useer);
	        ...
	        save.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					...
					flat=UserProfileData.this.flat.getText().toString();
					ssn=UserProfileData.this.ssn.getText().toString();
					occ=occupation.getText().toString();
					contact=UserProfileData.this.contact.getText().toString();
